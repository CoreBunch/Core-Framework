...
export const fluidTypographyGroupSchema = z.object({
	id: z.string(),
	name: z.string(),
	...
	genFontSizeClass: z.boolean().optional().describe("Deprecated"),
...
export const oldFluidTypographySchema = fluidTypographyGroupSchema.omit({ id: true, name: true });

export const typographyClassGenerationSchema = z.object({
	id: z.string(),
	name: z.string(),
...
export const fluidTypographySchema = z.object({
	groups: z.array(fluidTypographyGroupSchema),
	isDisabled: z.boolean().optional(),
	classes: z.array(typographyClassGenerationSchema).optional(),
});
