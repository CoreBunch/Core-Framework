const FilledLightModeIcon = ({ size = 24, color }) => (
	<svg
...
const FilledDarkModeIcon = ({ size = 24, color }) => (
	<svg
		xmlns="http://www.w3.org/2000/svg"
...
const OutlineLightModeIcon = ({ size = 24, color }) => (
	<svg
		xmlns="http://www.w3.org/2000/svg"
		className="cf-theme-icon cf-light-mode-icon"
		color="currentColor"
...
const OutlineDarkModeIcon = ({ size = 24, color }) => (
	<svg
		xmlns="http://www.w3.org/2000/svg"
		className="cf-theme-icon cf-dark-mode-icon"
		color="currentColor"
...
export const Icons = ({ icon_size, dark_mode_color, light_mode_color, icon_type }) => (
	<>
		{icon_type === "filled" ? (
