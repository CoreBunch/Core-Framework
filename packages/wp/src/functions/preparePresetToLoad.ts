...
interface IPreparePresetToLoad {
	...
	readonly oldPreferences?: Partial<Preferences> | undefined;
}
...
export function convertModulesDataToArray(preset: Preset) {
	...
	updatedPreset = {
		...updatedPreset,
		clickableParentClass: preset?.clickableParentClass ?? DEFAULT_EXPAND_CLICK_CLASSNAME,
		srOnlyClass: preset?.srOnlyClass ?? DEFAULT_SR_ONLY_CLASSNAME,
	};
