...
interface IManualRow {
	...
	readonly onSpaceChange: (sizes: any[]) => void;
	readonly spacingState: SpacingItem;
}

export const ManualRow = memo<IManualRow>(({ size, onSpaceChange, spacingState }) => {
	...
	const duplicateSize = (id: string) => {
		const newSizes = [...(spacingState?.manualSizes || [])];
	...
	return (
		<li ref={setNodeRef} style={style} {...attributes} className="class-row typo-layout-manual">
			...
			<div className="calculator-preview">
				<div className="calculator-preview-single row	gap-s">
					<Phone />
