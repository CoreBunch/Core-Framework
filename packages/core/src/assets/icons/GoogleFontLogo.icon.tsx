...
export const GoogleFontLogo = memo(function GoogleFontLogo() {
	return (
		<svg height="1952" viewBox="0 0 509.58086729 397.8808683" width="2500" xmlns="http://www.w3.org/2000/svg">
...
GoogleFontLogo.displayName = "GoogleFontLogo";
